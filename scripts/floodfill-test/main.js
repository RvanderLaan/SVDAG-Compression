...
const draw = (e) => {
    if (!e.buttons)
        return;
    const x = Math.floor(e.offsetX / canvasSize * resolution), y = Math.floor(e.offsetY / canvasSize * resolution);
    // ctx.fillStyle = 'black';
