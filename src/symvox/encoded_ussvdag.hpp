...
class EncodedUSSVDAG : public EncodedOctree {
...
public:
	...
	virtual std::string getDescription() const { return "USSVDAG. Encoded like [Kampe et al] paper, adding mirroring info to the header of each node."; }
